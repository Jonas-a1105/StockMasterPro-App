...
import {
  ...
  ReorderCatalogItemsDto,
} from '../dto/social-catalog.dto';
...
export class SocialController {
  ...
  async searchProfiles(
    ...
    return this.socialService.searchProfiles(
      query || '',
      user.tenantId,
      user.id,
    );
  ...
  async getCatalogs(
    ...
    return this.socialService.getCatalogs(
      user.tenantId,
      user.id,
      Number(page) || 1,
      Number(limit) || 20,
  ...
  async getPublicCatalogs(
    ...
    return this.socialService.getPublicCatalogs(
      user.tenantId,
      Number(page) || 1,
      Number(limit) || 20,
    );
  ...
  async addCatalogItem(
    ...
    @Body() dto: AddCatalogItemDto,
    @CurrentUser() user: AuthenticatedUser,
  ) {
    return this.socialService.addCatalogItem(
      catalogId,
      user.tenantId,
      user.id,
      dto,
  ...
  async updateCatalogItem(
    ...
    return this.socialService.updateCatalogItem(
      itemId,
      catalogId,
      user.tenantId,
      user.id,
  ...
  async deleteCatalogItem(
    ...
    return this.socialService.deleteCatalogItem(
      itemId,
      catalogId,
      user.tenantId,
      user.id,
  ...
  async reorderCatalogItems(
    ...
    return this.socialService.reorderCatalogItems(
      catalogId,
      user.tenantId,
      user.id,
      dto.items,
  ...
  async getCatalogComments(
    ...
    return this.socialService.getCatalogComments(
      catalogId,
      user.tenantId,
      Number(page) || 1,
      Number(limit) || 20,
  ...
  async toggleFollow(
    ...
    return this.socialService.toggleFollow(
      user.tenantId,
      user.id,
      followedUserId,
    );
  ...
  async getThreadMessages(
    ...
    return this.socialService.getThreadMessages(
      threadId,
      user.id,
      user.tenantId,
      Number(page) || 1,

...
export const PLANS: Record<PlanTier, { name: string; price: number; description: string; badge?: string }> = {
  free: { name: 'Free', price: 0, description: 'Gestión básica para un punto de venta o almacén pequeño.' },
  pro: { name: 'PRO', price: 39, description: 'Ideal para negocios con personal a cargo, cuentas corrientes de clientes y control de inventario.', badge: 'MÁS ELEGIDO' },
  enterprise: { name: 'Enterprise', price: 79, description: 'Auditoría avanzada para operaciones de alta facturación que requieren cuidar su margen de ganancia.' },
};
...
export const PLAN_FEATURES: PlanFeature[] = [
  ...
  { id: 'products_unlimited', label: 'Productos ilimitados', free: false, pro: true, enterprise: true },
  ...
  { id: 'inventory_adj', label: 'Ajustes de inventario (mermas)', free: false, pro: true, enterprise: true },
  ...
  { id: 'customers_credit', label: 'Clientes con crédito', free: false, pro: true, enterprise: true },
  ...
  { id: 'multiple_carts', label: 'Múltiples carritos en espera', free: false, pro: true, enterprise: true },
  { id: 'payment_methods', label: 'Pago con tarjeta y transferencia', free: false, pro: true, enterprise: true },
  { id: 'users_unlimited', label: 'Usuarios ilimitados', free: false, pro: false, enterprise: true },
  { id: 'warehouses_unlimited', label: 'Almacenes ilimitados', free: false, pro: false, enterprise: true },
  ...
  { id: 'multiple_warehouses', label: 'Multi-sucursal / almacén', free: false, pro: false, enterprise: true },
  { id: 'pwa_offline', label: 'PWA offline (POS sin internet)', free: false, pro: false, enterprise: true },
  { id: 'ui_customization', label: 'Personalización completa de UI', free: false, pro: false, enterprise: true },
  { id: 'exchange_rate', label: 'API tasa de cambio automática', free: false, pro: false, enterprise: true },
  { id: 'admin_panel', label: 'Panel de administración', free: false, pro: false, enterprise: true },
  { id: 'desktop_app', label: 'App de escritorio (Tauri)', free: false, pro: false, enterprise: true },
  { id: 'priority_support', label: 'Soporte prioritario', free: false, pro: false, enterprise: true },
];
...
export function getPlanLimits(tier: PlanTier) {
  const limits: Record<PlanTier, { maxProducts: number | null; maxUsers: number | null; maxWarehouses: number | null }> = {

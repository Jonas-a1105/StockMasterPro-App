...
function Card({ children, className = '', padding = true, onClick, style, ...props }: CardProps) {
  const classes = [styles.card, !padding ? styles.noPadding : '', onClick ? styles.clickable : '', className].filter(Boolean).join(' ');

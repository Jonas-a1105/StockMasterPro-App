        ...
        <div className={styles.toolbarActions}>
          ...
          <div className={styles.sortDropdown} ref={sortRef}>
            ...
            >
              ...
              <ChevronDown
                size={12}
                className={`${styles.sortChevron} ${showSortMenu ? styles.sortChevronOpen : ''}`}
              />
            </button>
            {showSortMenu && (
              <div className={styles.sortDropdownMenu}>
                ...
                <button
                  className={`${styles.sortMenuItem} ${sortField === 'name' ? styles.sortMenuItemActive : ''}`}
                  onClick={() => onSort('name')}
                >
                  Nombre {sortField === 'name' && (sortDirection === 'asc' ? '(A-Z)' : '(Z-A)')}
                </button>
                <button
                  className={`${styles.sortMenuItem} ${sortField === 'price' ? styles.sortMenuItemActive : ''}`}
                  onClick={() => onSort('price')}
                >
                  Precio{' '}
                  {sortField === 'price' && (sortDirection === 'asc' ? '(Menor)' : '(Mayor)')}
                </button>
                <button
                  className={`${styles.sortMenuItem} ${sortField === 'stock' ? styles.sortMenuItemActive : ''}`}
                ...
                <button
                  className={`${styles.sortMenuItem} ${sortField === 'status' ? styles.sortMenuItemActive : ''}`}

// src/features/inventory/pages/InventoryPage/InventoryPage.tsx
import { useState, lazy, Suspense } from 'react';
import { Package, Truck, ShoppingCart, AlertTriangle, FileText, ClipboardList } from 'lucide-react';
import { TabNav, Stack, Card, CardBody, Skeleton } from '@shared/ui';
import { ProductsTab, KardexTab, AdjustmentsTab, ConteoFisicoTab } from '../../components';
